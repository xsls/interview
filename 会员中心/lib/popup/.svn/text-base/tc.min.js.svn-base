function popWin(a) {
    function n() {
        var a = k ? k : document.body, b = a.scrollHeight > a.clientHeight ? a.scrollHeight : a.clientHeight, c = a.scrollWidth > a.clientWidth ? a.scrollWidth : a.clientWidth;
    ...
    f.css({"z-index": b - -1}), i.mousedown(function (a) {
        ...
        $(this).parent().parent().hide(), $("#maskLayer").remove()
    }), $('<div id="maskLayer"></div>').appendTo("body").css({background: "#000", opacity: ".4", top: 0, left: 0, position: "absolute", zIndex: "8000"}), n(), $(window).bind("resize", function () {
        n()
